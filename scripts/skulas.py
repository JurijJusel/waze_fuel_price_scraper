...
log = Script_log()
station_skulas = FuelCrawler(name='Skulas')
name = station_skulas.name
selected_url = station_skulas.get_url_by_company_name()
fuel_data = 'fuel.json'
...
data = get_skulas_data(download_response(selected_url))
