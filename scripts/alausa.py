...
log = Script_log()
station_alausa = FuelCrawler(name='Alausa')
name = station_alausa.name
selected_url = station_alausa.get_url_by_company_name()
fuel_data = 'fuel.json'
...
data = get_alausa_data(download_response(selected_url))
