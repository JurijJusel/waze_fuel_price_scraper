...
log = Script_log()
station_viada = FuelCrawler(name='Viada')
name = station_viada.name
selected_url = station_viada.get_url_by_company_name()
fuel_data = 'fuel.json'
...
data = get_viada_data(download_response(selected_url))
