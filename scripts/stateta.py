...
log = Script_log()
station_stateta = FuelCrawler(name='Stateta')
name = station_stateta.name
selected_url = station_stateta.get_url_by_company_name()
fuel_data = 'fuel.json'
...
data = get_stateta_data(download_response(selected_url))
