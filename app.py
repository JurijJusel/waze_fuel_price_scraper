...
data_to_json = circlek_prices(download_response(urls[1]))

create_json(data_to_json, 'fuel.json')


# if __name__ == '__main__':
    # download_response(urls[1]).run()
    # print(circlek_prices)
